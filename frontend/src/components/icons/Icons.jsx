...
export const Svg = ({ s = 24, vb = "0 0 24 24", children, style = {} }) => (
  <svg width={s} height={s} viewBox={vb} fill="none" style={style}>
    {children}
  </svg>
);
...
export const WeatherIcon = ({ type, s = 28 }) => {
      ...
      >
        ...
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg, i) => {
          const r = (Math.PI * deg) / 180,
            ...
            x2 = 12 + 9.8 * Math.cos(r),
            y2 = 12 + 9.8 * Math.sin(r);
          return (
            <line
              key={i}
              x1={x1}
  ...
  if (type === "rain")
    return (
      <Svg s={s}>
        <path
          d="M18 9.5h-1.1A7 7 0 1 0 8 18.5h10a4.5 4.5 0 0 0 0-9z"
          fill="#93C5FD"
          stroke="#60A5FA"
          strokeWidth="0.5"
        />
  ...
  >
    ...
    <svg
      ...
      style={{
        position: "relative",
        zIndex: 1,
        filter: "drop-shadow(0 6px 18px rgba(22,163,74,0.38))",
      }}
    >
      <defs>
...
export const paths = {
  ...
  leaf: [
    "M12 2C6 2 3 7 3 12c0 4 2.5 7 6 8.5",
    "M12 2c6 0 9 5 9 10 0 4-2.5 7-6 8.5",
    "M12 2v18",
  ],
  camera: [
  ...
  wheat: [
    "M12 22V2",
    "M7 7c0-2.5 5-4 5-4s5 1.5 5 4",
    "M7 12c0-2.5 5-4 5-4s5 1.5 5 4",
    "M7 17c0-2.5 5-4 5-4s5 1.5 5 4",
  ],
  close: ["M18 6L6 18", "M6 6l12 12"],
  gps: [
    "M12 2a7 7 0 0 1 7 7c0 5-7 13-7 13S5 14 5 9a7 7 0 0 1 7-7z",
    "M12 9a2 2 0 1 0 0-4 2 2 0 0 0 0 4z",
  ],
};

export const G = ({ n, s = 16, c = "currentColor", w = 1.8, style = {} }) => (
  <Ic d={paths[n] || paths.info} s={s} c={c} w={w} style={style} />
);
