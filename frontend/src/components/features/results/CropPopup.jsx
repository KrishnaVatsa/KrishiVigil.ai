...
import { getMSP } from "../../../utils/helpers";
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            <div
              style={{ fontWeight: 800, fontSize: "1.05rem", color: T.deep }}
            >
              Your Farm Details
            </div>
            <div style={{ fontSize: "0.7rem", color: T.muted, marginTop: 2 }}>
              Used by AI for accurate crop-specific analysis
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <div
            style={{
              ...
              alignItems: "center",
              gap: 8,
              background: focused === "c" ? "#f0fdf4" : "#f9fafb",
              borderRadius: 12,
              padding: "11px 14px",
              border: `1.5px solid ${focused === "c" ? T.green : T.border}`,
              transition: "all 0.2s",
              animation: err && !crop ? "shakeX 0.4s ease" : undefined,
            }}
          >
          ...
          >
            {crops.slice(0, 6).map((c) => (
              <button
                ...
                onClick={() => setCrop(c)}
                style={{
                  background: crop === c ? T.green : T.border2,
                  color: crop === c ? "#fff" : T.deep,
                  border: `1px solid ${crop === c ? T.green : T.border}`,
                  borderRadius: 20,
                  padding: "4px 10px",
                  fontSize: "0.65rem",
                  fontWeight: 600,
          ...
          {crop && (
            ...
            >
              ...
              <span
                style={{ fontSize: "0.7rem", color: T.deep, fontWeight: 600 }}
              >
                MSP: Rs {(getMSP(crop) / 100).toFixed(2)}/kg{" "}
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div
            style={{
              ...
              alignItems: "center",
              gap: 8,
              background: focused === "l" ? "#f0fdf4" : "#f9fafb",
              borderRadius: 12,
              padding: "11px 14px",
              border: `1.5px solid ${focused === "l" ? T.green : T.border}`,
              transition: "all 0.2s",
              animation: err && !land ? "shakeX 0.4s ease" : undefined,
            }}
          >
          ...
          <div style={{ display: "flex", gap: 5, marginTop: 8 }}>
            {["0.5", "1", "2", "3", "5", "10"].map((v) => (
              <button
                ...
                onClick={() => setLand(v)}
                style={{
                  background: land === v ? T.green : T.border2,
                  color: land === v ? "#fff" : T.deep,
                  border: `1px solid ${land === v ? T.green : T.border}`,
                  borderRadius: 20,
                  padding: "4px 9px",
                  fontSize: "0.65rem",
                  fontWeight: 600,
