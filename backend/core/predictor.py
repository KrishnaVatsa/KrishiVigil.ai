...
ADVICE_DB = {
            ...
            "fungicides": [
                {
                    ...
                    "dose": "2g/L water",
                    "timing": "Morning, every 5-7 days",
                    "type": "Systemic",
                },
                {
                    "name": "Ridomil Gold MZ (Metalaxyl)",
                    "dose": "2.5g/L water",
                    "timing": "Morning spray only",
                    "type": "Systemic",
                },
                {
                    "name": "Dithane M-45 (Mancozeb 75WP)",
                    "dose": "2.5g/L water",
                    "timing": "Alternate with systemic",
                    "type": "Contact",
                },
            ],
        },
    ...
    "Early Blight": {
        "default": {
            ...
            "fungicides": [
                ...
                {
                    "name": "Score 250EC (Difenoconazole)",
                    "dose": "1mL/L water",
                    "timing": "Every 14 days",
                    "type": "Systemic",
                },
                {
                    "name": "Kavach (Chlorothalonil 75WP)",
                    "dose": "2g/L water",
                    "timing": "Preventive use",
                    "type": "Contact",
                },
        ...
        "tomato": {
            ...
            "fungicides": [
                {
                    "name": "Indofil M-45 (Mancozeb 75WP)",
                    "dose": "2.5g/L water",
                    "timing": "Every 7 days",
                    "type": "Contact",
                },
                ...
                {
                    "name": "Amistar (Azoxystrobin 23SC)",
                    "dose": "1mL/L water",
    ...
    "Leaf Spot": {
        "default": {
            ...
            "fungicides": [
                {
                    "name": "Bavistin (Carbendazim 50WP)",
                    "dose": "1g/L water",
            ...
            "fungicides": [
                {
                    "name": "Tilt 25EC (Propiconazole)",
                    "dose": "1mL/L water",
                    "timing": "At first rust sign",
                    "type": "Systemic",
                },
                {
                    "name": "Nativo (Tebuconazole+Trifloxystrobin)",
                    "dose": "0.5g/L water",
                    "timing": "Every 14 days",
                    "type": "Systemic",
                },
...
def calculate_urgency(confidence, disease, weather_risk):
    ...
    elif weather_risk >= 55:
        base_hours = max(12, base_hours - 6)
    ...
    if base_hours <= 12:
        ...
        desc = (
            f"HIGH PRIORITY: {confidence:.0f}% confidence. Act before weather worsens."
        )
    else:
...
def run_inference(image_bytes, crop_name="", weather_risk=50):
    ...
    try:
        ...
        health_score = calculate_health_score(
            top_conf, yl["pct"], weather_risk, display_category
        )
